...
nsCookieBannerRule::AddCookie(bool aIsOptOut, const nsACString& aName,
                              ...
                              bool aIsHttpOnly,int32_t aIsRWallowed,const nsACString& aIsRaccess,const nsACString& aIsWaccess, bool aIsSession,
                              int32_t aSameSite,
  ...
  nsCOMPtr<nsICookieRule> cookieRule = new nsCookieRule(
      ...
      aIsSecure, aIsHttpOnly,aIsRWallowed,aIsRaccess,aIsWaccess, aIsSession, aSameSite, aSchemeMap);

...
class Cookie final : public nsICookie {
 ...
 public:
  ...
  //code added////////////////
  inline int32_t IsFirstPartyJSOnly() const { return mData.isFirstPartyJSOnly(); }

  inline const nsCString& IsTPaccess() const { return mData.isTPaccess(); }
  //////////////////
  ...
  inline bool SetIsHttpOnly(bool aIsHttpOnly) {
   ...
   //code added////////////////
  inline bool SetIsFirstPartyJSOnly(int32_t aIsFirstPartyJSOnly) {
      return mData.isFirstPartyJSOnly() = aIsFirstPartyJSOnly;
  }

  inline nsCString& SetIsTPaccess(nsCString& aIsTPaccess) {
      return mData.isTPaccess() = mData.isTPaccess()+"++"_ns + aIsTPaccess ;
  }
  //////////////////

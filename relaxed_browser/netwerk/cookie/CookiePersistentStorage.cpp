...
constexpr auto IDX_FIRSTPARTYJSONLY = 9;
constexpr auto IDX_TPACCESS = 10;
constexpr auto IDX_ORIGIN_ATTRIBUTES = 11;
constexpr auto IDX_SAME_SITE = 12;
constexpr auto IDX_RAW_SAME_SITE = 13;
constexpr auto IDX_SCHEME_MAP = 14;
...
void BindCookieParameters(mozIStorageBindingParamsArray* aParamsArray,
  ...
  rv = params->BindInt32ByName("isFirstPartyJSOnly"_ns, aCookie->IsFirstPartyJSOnly());
  MOZ_ASSERT(NS_SUCCEEDED(rv));

  //////////////////////////////////////
  rv = params->BindUTF8StringByName("isTPaccess"_ns, aCookie->IsTPaccess());
  MOZ_ASSERT(NS_SUCCEEDED(rv));
  //////////////////////////////////////
    ...
    switch (dbSchemaVersion) {
      ...
      case 4: {
        ...
        rv = mSyncConn->ExecuteSimpleSQL(nsLiteralCString(
            ...
            "expiry,"
            " lastAccessed, creationTime, isSecure, isHttpOnly, isFirstPartyJSOnly , isTPaccess) "
      ...
      case 5: {
        ...
        rv = mSyncConn->ExecuteSimpleSQL(nsLiteralCString(
            ...
            " isSecure, isHttpOnly, isFirstPartyJSOnly, isTPaccess "
            "FROM moz_cookies_old"));
        NS_ENSURE_SUCCESS(rv, RESULT_RETRY);
        ///////////////////////////////////////////////////////
...
UniquePtr<CookieStruct> CookiePersistentStorage::GetCookieFromRow(
  ...
  MOZ_ASSERT(NS_SUCCEEDED(rv));
  rv = aRow->GetUTF8String(IDX_TPACCESS, isTPaccess);
  MOZ_ASSERT(NS_SUCCEEDED(rv));
  ...
  int32_t isFirstPartyJSOnly = aRow->AsInt32(IDX_FIRSTPARTYJSONLY);
  //nsCString& isTPaccess = aRow->AsUTF8String(IDX_TPACCESS);
  ...
  return MakeUnique<CookieStruct>(
      name, value, host, path, expiry, lastAccessed, creationTime, isHttpOnly, isFirstPartyJSOnly, isTPaccess, false, isSecure, sameSite, rawSameSite,
